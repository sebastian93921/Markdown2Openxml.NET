...
{
    public class UnorderListParagraphProcessor : ParagraphProcessorInterface
    {
        ...
        {
            Regex unorderListRegex = MarkdownPatternProcessor.ParagraphPatterns[ParagraphPattern.UnorderedList];
