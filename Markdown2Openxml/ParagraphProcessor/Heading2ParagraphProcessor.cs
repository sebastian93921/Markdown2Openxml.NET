...
{
    public class Heading2ParagraphProcessor : ParagraphProcessorInterface
    {
        ...
        public IList<OpenXmlCompositeElement> process(MainDocumentPart mainDocumentPart, StringArrayReader reader)
        {
            ...
            FontSize fontSize1 = new FontSize() { Val = "34" };
            runProperties1.Append(fontSize1);

            run.Append(runProperties1);

            string input = reader.getCurrentString().Substring(3);
